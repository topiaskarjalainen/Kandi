...
\begin{esim}
	...
	\begin{equation}
		J_n(\theta_n|\theta_{n-1}) \sim N(\theta_{n-1}, I_2)
	\end{equation}
	jossa $I_2$ on 2x2 yksikkömatriisi. Nyt Metropolis Hastings algoritmin avulla voidaan simuloida jakaumaa $p(\theta)$ algoritmilla \ref{mh-maar}. Simuloiddaan kaksi Markovin ketjua asettemalla aloitustiloiksi $(0,0)$ ja $(5,5)$. 
	\begin{figure}[h!]
