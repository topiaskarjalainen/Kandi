...
\begin{esim}
	Tarkastellaan esimerkin \ref{MH-esim2} tilannetta. Simuloimme siinä 100 000 iteraatiota ilman burn-in periodia. Arvioidaan tälle ketjulle $\hat{R}$ ja $\hat{n}_{eff}$.
	\begin{center}
