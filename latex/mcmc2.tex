...
\section{Metropolis--Hastings algoritmi}
...
\begin{esim}\label{mh-esim1}
	...
	\begin{figure}[h!]
		...
		\caption{\textit{Vasemmalla: (5,5). Keskellä: (0,0) Oikealla: tiheysestimaatti (huomaa eri skaala).}}
		\label{kuva1}
	\end{figure}
...
\begin{esim}\label{MH-esim2}
	...
	\end{equation*}
	Valitaan hieman erikoinen ehdotusjakauma:
	\begin{equation}
	...
	\begin{figure}[h!]
		\includegraphics[width=\textwidth]{mhexample2}
		\caption{Esimerkin \ref{MH-esim2} tulokset}
	\end{figure}
\end{esim}
